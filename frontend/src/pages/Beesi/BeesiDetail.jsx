    ...
    <div className="min-h-screen bg-slate-50">
      ...
      >
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mt-6">
          <HeroStat
            label="Pot Size"
            value={formatCurrency(beesi.pot_size)}
            accent="indigo"
          />
          <HeroStat
              ...
              return (
                <div className="mt-6 bg-white rounded-2xl border border-slate-200/60 shadow-sm p-5">
                  ...
                  <div className="bg-indigo-50 border border-indigo-100 rounded-xl px-4 py-3 mb-4 text-xs text-indigo-800 leading-relaxed">
                    ...
                    P&amp;L depends only on your bid discount — not on which
                    month you pick. What changes per month is{" "}
                    <em>
                      how much cash you still owe after receiving the pot.
                    </em>{" "}
