    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900 px-4">
      <div className="max-w-md w-full">
        <div className="text-center mb-8">
          ...
          <p className="text-blue-200/70 text-sm mt-1">Advanced Finance Tracker</p>
        </div>
        ...
        <div className="bg-white/10 backdrop-blur-xl rounded-2xl shadow-2xl p-8 border border-white/10">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <label htmlFor="username" className="block text-sm font-medium text-blue-100/80 mb-1.5">
                Username
              </label>
              <input
                id="username"
            ...
            <div>
              <label htmlFor="password" className="block text-sm font-medium text-blue-100/80 mb-1.5">
                Password
              </label>
              <input
                id="password"
