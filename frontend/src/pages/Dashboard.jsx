  ...
  return (
    <div className="bg-white rounded-xl border border-gray-100 p-4 sm:p-5 hover:shadow-md transition-shadow">
      <div className="flex items-start justify-between">
        ...
        <div
          className={`shrink-0 w-10 h-10 rounded-lg bg-gradient-to-br ${bgTone} flex items-center justify-center ml-3`}
        >
          <svg
              ...
              <table className="w-full text-sm min-w-[640px]">
                <thead>
                  <tr className="border-b border-gray-100 text-left">
                    ...
                    <th className="pb-3 pr-4 text-right text-xs font-semibold text-gray-400 uppercase tracking-wider">
                      Rate
                    </th>
                    <th className="pb-3 pl-4 text-xs font-semibold text-gray-400 uppercase tracking-wider">
                      Last Payment
                    </th>
