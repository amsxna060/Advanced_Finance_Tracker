...
export default function ExpenseAnalytics() {
  ...
  const { data, isLoading } = useQuery({
    ...
    queryFn: async () => {
      ...
      return (await api.get("/api/expenses/analytics/summary", { params }))
        .data;
    },
  });
        ...
        <div className="max-w-7xl mx-auto space-y-6">
          ...
          <div>
            ...
            <p className="text-gray-600 mt-1">
              Analyze spending patterns across categories, time periods, and
              accounts.
            </p>
          </div>
            ...
            <div className="flex flex-wrap items-center gap-3">
              <div className="flex items-center gap-2">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setRange((r) => ({ ...r, from_date: e.target.value }))
                  }
              ...
              <div className="flex items-center gap-2">
                ...
                <input
                  ...
                  value={range.to_date}
                  onChange={(e) =>
                    setRange((r) => ({ ...r, to_date: e.target.value }))
                  }
                  className="px-3 py-1.5 border border-gray-300 rounded-lg text-sm"
                />
              </div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <div className="bg-white rounded-lg shadow-sm p-5">
                  ...
                  <div className="text-2xl font-bold text-gray-900 mt-1">
                    {formatCurrency(
                      data?.expense_count
                        ? Number(data.grand_total) / data.expense_count
                        : 0,
                    )}
                  </div>
                </div>
                  ...
                  <table className="min-w-full text-sm">
                    <thead>
                      <tr className="border-b border-gray-100">
                        <th className="py-2 text-left text-xs font-semibold text-gray-400 uppercase">
                          Category
                        </th>
                        <th className="py-2 text-right text-xs font-semibold text-gray-400 uppercase">
                          Amount
                        </th>
                        <th className="py-2 text-right text-xs font-semibold text-gray-400 uppercase">
                          Count
                        ...
                        <th className="py-2 text-left text-xs font-semibold text-gray-400 uppercase pl-4">
                          Distribution
                        </th>
                      </tr>
                    </thead>
                    <tbody>
                      {categories.map((cat, i) => {
                        const pct =
                          data?.grand_total > 0
                            ? (Number(cat.total) / Number(data.grand_total)) *
                              100
                            : 0;
                        return (
                          <tr
