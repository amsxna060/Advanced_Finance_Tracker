          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
              ...
              <StatCard
                ...
                value={formatCurrency(summary?.principal_outstanding || 0)}
                accent="teal"
              />
              <StatCard
                label="Interest Accrued"
                              ...
                              <>
                                ...
                                {showInterest > 0 && (
                                  <div className="text-xs text-amber-600">
                                    +{formatCurrency(showInterest)} int
                                  </div>
                                )}
                              </>
                            );
                  ...
                  <CardBody className="space-y-2 !py-3">
                    {obligations.map((item) => {
                      ...
                      return (
                        <div
                          key={ob.id}
                          className={`flex items-start justify-between gap-3 rounded-xl border px-4 py-3 ${isReceivable ? "border-emerald-100 bg-emerald-50/40" : "border-rose-100 bg-rose-50/40"}`}
                        >
